...
month_pyt VARCHAR(15) NOT NULL,
due_date_pyt VARCHAR(15) NOT NULL,
star_date_pyt VARCHAR(15) NOT NULL,
end_date_pyt VARCHAR(15) NOT NULL,
...
CONSTRAINT MINIMUM_4_CHARACTERS_NAME CHECK(CHAR_LENGTH(month_pyt)>=4),
CONSTRAINT ONLY_LETTERS CHECK(month_pyt REGEXP '[^0-9]'),
CONSTRAINT NO_SIMBOLS CHECK(month_pyt REGEXP '^[A-ZÑ ]+$'),
CONSTRAINT ONLY_UPPERCASE_LETTERS CHECK(month_pyt REGEXP '^[A-ZÑ]+$'),
